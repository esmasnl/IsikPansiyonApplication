...
namespace ışık_pansiyon_uygulaması_V._1
{
    public partial class FrmMusteriler : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            listView1.Items.Clear();
            baglanti.Open();
            SqlCommand komut = new SqlCommand("select * from MusteriEkle1 where Adi like  '%"+textBox1.Text+"%'" , baglanti);
            SqlDataReader oku = komut.ExecuteReader();
...
//SqlCommand komut = new SqlCommand("delete from MusteriEkle1 where Musteriid=(" + id + ")", baglanti);